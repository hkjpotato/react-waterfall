...
/***/ function(module, exports, __webpack_require__) {
	...
	var springConfig = { stiffness: 300, damping: 40 };
	var springConfig_shadow = { stiffness: 300, damping: 40 };

	var Waterfall = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var initTop = this.state.initTop;

	    var defaultStyles = data.map(function (d, i) {
	      return {
	        marginTop: initTop,
	        shadow: 20
	      };
	      ...
	      _reactMotion.StaggeredMotion,
	      {
	        ...
	        styles: function styles(prevInterpolatedStyles) {
	          return prevInterpolatedStyles.map(function (_, i) {
	            return i === 0 ? { marginTop: (0, _reactMotion.spring)(_this.state.finalTop, springConfig), shadow: (0, _reactMotion.spring)(2, springConfig_shadow) } : { marginTop: (0, _reactMotion.spring)(prevInterpolatedStyles[i - 1].marginTop, springConfig), shadow: (0, _reactMotion.spring)(prevInterpolatedStyles[i - 1].shadow, springConfig_shadow) };
	          });
	        } },
	      function (interpolatingStyles) {
	        return _react2.default.createElement(
	          ...
	          interpolatingStyles.map(function (style, i) {
	            return _react2.default.createElement('div', { className: 'waterfall-item', key: i, style: {
	...
	var Demo = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    $(window).scroll(function () {
	      if ($(window).scrollTop() + $(window).height() == $(document).height()) {
	        ...
	        _this2.setState({
	          itemNum: _this2.state.itemNum + 1
	        });
	      }
	    });
	  },
	  render: function render() {
	    ...
	    for (var i = 0; i < this.state.itemNum; i++) {
	      items.push(_react2.default.createElement(Waterfall, { data: data, finalTop: 10, key: i }));
	    }
	    return _react2.default.createElement(
	      'div',
	      null,
	...
	_reactDom2.default.render(_react2.default.createElement(Demo, null), document.querySelector('#waterfall-container'));
